...
<script id="project-content-tpl" type="text/x-handlebars-template">
    {{#if project}}
        <p>
        <input type="text" name="project-name" id="project-name" {{#if project.name}} value="{{ project.name }}" {{/if}}/>
    ...
    {{else}}
        <p>Hello Hello!
        <input disabled type="text" name="project-name" id="project-name" placeholder="<?php p($l->t('Project name')); ?>" />
